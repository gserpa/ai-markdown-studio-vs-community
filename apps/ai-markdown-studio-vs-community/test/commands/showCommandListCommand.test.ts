    ...
    featureContributionsMock.listFeatureContributions.mockReturnValue([
      {
        ...
        commands: [
          { command: 'markdownAiStudio.validatePptxTemplate', title: 'PPTX Tools: Validate Template' },
          { command: 'markdownAiStudio.exportPdf', title: 'Export: PDF' },
          { command: 'markdownAiStudio.generatePresentationTheme', title: 'AI: Generate Presentation Theme' },
          { command: 'markdownAiStudio.generateDocumentTheme', title: 'AI: Generate Document Theme' },
          { command: 'markdownAiStudio.exportDocx', title: 'Export: DOCX' },
          { command: 'markdownAiStudio.exportPptx', title: 'Export: PPTX' },
          { command: 'markdownAiStudio.generatePptxTemplateManifest', title: 'PPTX Tools: Generate Template Manifest' },
        ],
      },
    ]);
  });
